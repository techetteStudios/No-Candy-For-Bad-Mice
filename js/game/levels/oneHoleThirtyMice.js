oneHoleThirtyMice = function()
{
    ...
    this.tools.cMouse(this.percentageOfWidth(0.1),this.percentageOfHeight(0.2));
    this.tools.cMouse(this.percentageOfWidth(0.1),this.percentageOfHeight(0.25));
    this.tools.cMouse(this.percentageOfWidth(0.1),this.percentageOfHeight(0.4));
    ...
    this.tools.cMouse(this.percentageOfWidth(0.5),this.percentageOfHeight(0.15));
    this.tools.cMouse(this.percentageOfWidth(0.5),this.percentageOfHeight(0.2));
    ...
    this.tools.cMouse(this.percentageOfWidth(0.8),this.percentageOfHeight(0.1));
    this.tools.cMouse(this.percentageOfWidth(0.8),this.percentageOfHeight(0.1));
    this.tools.cMouse(this.percentageOfWidth(0.8),this.percentageOfHeight(0.15));
    this.tools.cMouse(this.percentageOfWidth(0.8),this.percentageOfHeight(0.2));
    this.tools.cMouse(this.percentageOfWidth(0.8),this.percentageOfHeight(0.25));
    this.tools.cMouse(this.percentageOfWidth(0.8),this.percentageOfHeight(0.4));
    this.tools.cMouse(this.percentageOfWidth(0.8),this.percentageOfHeight(0.3));
    this.tools.cMouse(this.percentageOfWidth(0.8),this.percentageOfHeight(0.3));
