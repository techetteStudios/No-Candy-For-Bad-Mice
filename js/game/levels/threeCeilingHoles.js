threeCeilingHoles = function()
{
    ...
    this.topWidth = 100;
    this.topLeftXPos =  this.percentageOfWidth(0.35);
    this.topRightXPos =  this.percentageOfWidth(0.65);
