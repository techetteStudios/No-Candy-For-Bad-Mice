miceFallingOutTopBox = function()
{
    ...
    //Params to set hole
    this.bottomWidth = this.width-50;
    this.bottomXPos =  this.percentageOfWidth(0.2);
    this.bottomShelfXPos =  this.percentageOfWidth(0.7);
    ...
    this.tools.cMouse(this.percentageOfWidth(0.3),this.percentageOfHeight(0.1));
    this.tools.cMouse(this.percentageOfWidth(0.3),this.percentageOfHeight(0.1));
    this.tools.cMouse(this.percentageOfWidth(0.3),this.percentageOfHeight(0.15));
